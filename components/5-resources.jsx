...
const resources = [
  ...
  },
  {
    ...
    description:
      "Gabriella Reznowski, one of the leaders of this research project and a librarian at Washington State University, has compiled a list of Ukrainian books that can be purchased.",
    url: "https://libguides.libraries.wsu.edu/ld.php?content_id=74403322",
  },
  {
    name: "Ukrainian Libraries in Wartime",
    description:
      "This article from Library Journal discusses the impact of the war on Ukrainian libraries. It also shows why it is important to preserve Ukrainian books and records.",
    url: "https://www.libraryjournal.com/story/ukrainian-libraries-in-wartime",
  },
  {
    name: "UNWLA - Children's Book List",
    description:
      "The UNWLA has compiled a list of Ukrainian children's books that are available to read and for libraries to purchase.",
    url: "https://libguides.libraries.wsu.edu/ld.php?content_id=71193562",
  },
  {
    name: "WSU Library Guide",
    description:
      "Gabriella Reznowski has created a guide to help librarians and people learn more about supporting Ukrainian refugees through library collections.",
    url: "https://libguides.libraries.wsu.edu/c.php?g=1252934&p=9176202",
  },
  {
    name: "Ukrainian E-Books",
    description:
      "Over 9000+ Ukrainian e-books are available in Overdrive. You can search for books in Ukrainian and other languages.",
        ...
        <div id="resources" className=" py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-[590px] lg:mx-0">
              <h2 className="text-2xl font-medium tracking-tight text-yellow-950 sm:text-4xl">
                Resources
              </h2>
              <span className={hedvigLettersSans.className}>
                <p className="mt-6 text-md sm:text-lg sm:leading-8 text-yellow-950/80">
                  ...
                  about other organizations and initiatives that are working to
            ...
            <div className="mt-12 grid grid-cols-1 gap-y-4 lg:grid-cols-2 lg:gap-x-4 mx-auto max-w-[590px] lg:max-w-full">
              {resources.map((resource) => (
                ...
                >
                  <Card
                    key={resource.name}
                    className="bg-[#fffefa] border-[#dbd8d1] flex flex-col h-full justify-between"
                  >
                    <div>
                      <CardHeader>
                        <CardTitle className=" tracking-tight text-base sm:text-xl">
                          {resource.name}
                        </CardTitle>
                      </CardHeader>
                    ...
                    <CardFooter className="mt-auto">
                      <p className="text-yellow-950 font-semibold">
                        <span className={hedvigLettersSans.className}>
                          Learn More{" "}
                          <ArrowUpRightSquare size={16} className="inline" />
                        </span>
                      </p>
                    </CardFooter>
                  </Card>
