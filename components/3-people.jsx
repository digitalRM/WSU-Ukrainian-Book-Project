...
export default function People() {
  ...
  const pathLength2 = useTransform(scrollYProgress, [0.5, 0.7], [0, 1]);
  ...
  return (
    <div id="members" className="w-screen bg-[#f3f1e9] overflow-hidden ">
      <div className="w-screen h-full relative">
        ...
        <motion.svg
          className="absolute svg:flex -mr-3  hidden lg:flex right-0 bottom-0 -mb-1"
          width="285"
          height="197"
          viewBox="0 0 285 197"
          fill="none"
            ...
            <div className="mx-auto max-w-[590px] lg:mx-0">
              ...
              <span className={hedvigLettersSans.className}>
                <p className="mt-6 text-md sm:text-lg sm:leading-8 text-yellow-950/80">
                  Our priority is simple: help librarians and people across the
                  United States access information about Ukrainian literature
                  collections.
                </p>
              </span>
            </div>
              ...
              {people.map((person) => (
                <li key={person.name}>
                  ...
                  >
                    ...
                    <Image
                      className="aspect-[2/2]  hover:rounded-[48px] bg-clip-content lg:hidden  xl:flex w-full rounded-2xl object-cover grayscale hover:grayscale-0 transition-all"
                      style={{ clipPath: "url(#clippy)" }}
                      width={280}
                      height={280}
                      src={person.imageUrl}
                  ...
                  <Image
                    className="sm:hidden hover:rounded-[48px] aspect-[2/2] lg:flex xl:hidden bg-clip-content w-full rounded-2xl object-cover grayscale hover:grayscale-0 transition-all"
                    width={280}
                    height={280}
                    src={person.imageUrl}
                    alt={"Photo of " + person.name}
                  />
                  <span className={hedvigLettersSans.className}>
                    <h3 className="mt-6 text-lg font-semibold leading-8 tracking-tight text-yellow-950">
                      {person.name}
                    </h3>
                  </span>
                  <span className={hedvigLettersSans.className}>
                    <p className="text-base leading-7 text-yellow-950/75">
                      {person.role}
                    </p>
                  </span>
                  <ul role="list" className="mt-6 flex flex-row gap-x-2">
                    <li>
                      <a
                        ...
                        className="text-yellow-950/70 hover:text-yellow-950/80"
                      >
